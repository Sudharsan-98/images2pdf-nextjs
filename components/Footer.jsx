    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">images2pdf.online</h3>
            <p className="text-gray-400">All-in-one solution for your PDF needs. Convert, edit, and manage your PDF files with ease.</p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} images2pdf.online. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
